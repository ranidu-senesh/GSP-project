...
export default function ProductGridViewWidget({ navigation, product }: any) {
  ...
  return (
    <View style={styles.container}>
      ...
      <TouchableOpacity style={styles.imageView} onPress={() => navigation.navigate('ProductDetails', { product: p })}>
